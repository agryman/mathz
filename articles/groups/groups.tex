...
\begin{zed}
	Carrier\_A[\genT] \defs Carrier[\genT][A / elements]
\also
	Carrier\_B[\genT] \defs Carrier[\genT][B / elements]
\also
	Carrier\_C[\genT] \defs Carrier[\genT][C / elements]
\end{zed}
...
\begin{zed}
	Carrier\_Map\_gBC[\genT, \genU] \defs Carrier\_Map\_fAB[\genT, \genU][g / f, B / A, C / B]
\also
	Carrier\_Map\_hAC[\genT, \genU] \defs Carrier\_Map\_fAB[\genT, \genU][h / f, C / B]
\end{zed}
